...
const EntityForm = ({ record, onSubmit, onCancel }) => {
  ...
  useEffect(() => {
    setValues(initialProviderValues);
  }, [initialProviderValues, setValues]);
  ...
  return (
    <Card className="mt-3">
      <Card.Header className="d-flex align-items-center justify-content-between">
        <div>
          <h6 className="mb-0">{record ? 'Edit SMS Provider' : 'Add New SMS Provider'}</h6>
          <small className="text-700">Provider details, HTTP and SMPP bind settings.</small>
        </div>
      ...
      <Card.Body>
        <Forms id="entity-form" onFinish={handleProviderSubmit}>
