...
const RangeFormModal = ({ show, onClose, record, onSubmit }) => {
  ...
  }, [show, initialRangeValues, setValues]);
  ...
  return (
    <UseModal
      title={record ? 'Edit Range' : 'Add New Range'}
      isVisible={show}
      setIsVisible={() => {}}
      onCancel={onClose}
      size="xl"
      footer={[
        ...
        <Button key="submit" variant="primary" size="sm" type="submit" form="range-form">
          {record ? 'Update' : 'Add'}
        </Button>
      ]}
    >
      <Forms id="range-form" onFinish={handleSubmitRange}>
