export default [
  {
    version: '5.1.0',
    title: `Peale’s Falcon`,
    publish: '23 November, 2025',
    logs: {
      New: [
        'Plugin: <code>@vis.gl/react-google-maps</code>',
      ],
      Update: [
        'Plugin: <code>@fullcalendar/bootstrap</code> from <code>6.1.18</code> to <code>6.1.19</code>.',
        'Plugin: <code>@fullcalendar/daygrid</code> from <code>6.1.18</code> to <code>6.1.19</code>.',
        'Plugin: <code>@fullcalendar/interaction</code> from <code>6.1.18</code> to <code>6.1.19</code>.',
        'Plugin: <code>@fullcalendar/list</code> from <code>6.1.18</code> to <code>6.1.19</code>.',
        'Plugin: <code>@fullcalendar/react</code> from <code>6.1.18</code> to <code>6.1.19</code>.',
        'Plugin: <code>@fullcalendar/timegrid</code> from <code>6.1.18</code> to <code>6.1.19</code>.',
        'Plugin: <code>@hookform/resolvers</code> from <code>5.1.1</code> to <code>5.2.2</code>.',
        'Plugin: <code>@tinymce/tinymce-react</code> from <code>6.2.1</code> to <code>6.3.0</code>.',
        'Plugin: <code>Bootstrap</code> from <code>5.3.7</code> to <code>5.3.8</code>.',
        'Plugin: <code>chart.js</code> from <code>4.5.0</code> to <code>4.5.1</code>.',
        'Plugin: <code>dayjs</code> from <code>1.11.13</code> to <code>1.11.19</code>.',
        'Plugin: <code>echarts</code> from <code>5.6.0</code> to <code>6.0.0</code>.',
        'Plugin: <code>echarts-for-react</code> from <code>3.0.2</code> to <code>3.0.5</code>.',
        'Plugin: <code>emoji-picker-react</code> from <code>4.13.2</code> to <code>4.15.1</code>.',
        'Plugin: <code>fs-extra</code> from <code>11.3.0</code> to <code>11.3.2</code>.',
        'Plugin: <code>leaflet.tilelayer.colorfilter</code> from <code>1.2.5</code> to <code>2.0.0</code>.',
        'Plugin: <code>plyr</code> from <code>3.7.8</code> to <code>3.8.3</code>.',
        'Plugin: <code>rc-slider</code> from <code>11.1.8</code> to <code>11.1.9</code>.',
        'Plugin: <code>react-chartjs-2</code> from <code>5.3.0</code> to <code>5.3.1</code>.',
        'Plugin: <code>react-datepicker</code> from <code>8.4.0</code> to <code>8.9.0</code>.',
        'Plugin: <code>react-dom</code> from <code>19.1.0</code> to <code>19.2.0</code>.',
        'Plugin: <code>react-hook-form</code> from <code>7.60.0</code> to <code>7.66.0</code>.',
        'Plugin: <code>react-player</code> from <code>3.3.1</code> to <code>3.4.0</code>.',
        'Plugin: <code>react-router</code> from <code>7.7.0</code> to <code>7.9.6</code>.',
        'Plugin: <code>react-slick</code> from <code>0.30.3</code> to <code>0.31.0</code>.',
        'Plugin: <code>tinymce</code> from <code>7.9.1</code> to <code>8.2.2</code>.',
        'Plugin: <code>uuid</code> from <code>11.1.0</code> to <code>13.0.0</code>.',
        'Plugin: <code>video.js</code> from <code>8.23.3</code> to <code>8.23.4</code>.',
        'Plugin: <code>web-vitals</code> from <code>5.0.3</code> to <code>5.1.0</code>.',
        'Plugin: <code>yet-another-react-lightbox</code> from <code>3.24.0</code> to <code>3.25.0</code>.',
        'Plugin: <code>yup</code> from <code>1.6.1</code> to <code>1.7.1</code>.',
        'Plugin: Removed <code>@react-google-maps/api</code>.',
        'JS: <code>src/components/map/GoogleMap</code> updated from <code>@react-google-maps/api</code> to <code>@vis.gl/react-google-maps</code>',
        'JS: <code>src/components/doc-components/GoogleMapExample</code> updated to latest <code>@vis.gl/react-google-maps</code> and StreetView Example added.',
        'JS: <code>src/components/app/e-learning/student-overview/BillingAddress.jsx</code>',
        'JS: <code>src/components/app/events/event-details/EventDetailsGmap.jsx</code>',
      ],
      Fix: [
        ...
        'Adjusted the Echarts legend options by adding an explicit <code>top</code> and <code>itemGap</code> value to ensure proper rendering',
        'Minor bugs.'
      ]
    }
  },
